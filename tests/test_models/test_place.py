#!/usr/bin/python3
"""Formulates unittests for models/place.py.
...
class TestPlace_instantiation(unittest.TestCase):
    """Testing for unittests instantiation winthin the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests for testing save method within the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method within the Place class."""
