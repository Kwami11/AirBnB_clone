#!/usr/bin/python3
"""Formulates Unittests for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for testing instantiation within the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests for testing save method within the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method within the City class."""
