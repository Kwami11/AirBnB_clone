#!/usr/bin/python3
"""Formulates unittests for models/state.py.
...
class TestState_instantiation(unittest.TestCase):
    """Unittests for testing instantiation within the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests for testing save method within the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method within the State class."""
