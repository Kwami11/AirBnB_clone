#!/usr/bin/python3
"""Formulates unittests for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """Unittests for testing instantiation within the User class."""
...
class TestUser_save(unittest.TestCase):
    """Unittests for testing save method within the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method within the User class."""
